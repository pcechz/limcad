  ...
  Widget businessBody() => Container(
    child: Column(
      children: [
        ...
        const Text( "Grow your laundry business by connecting with clients looking for professional services.",
          textAlign: TextAlign.center,
          style: TextStyle(
              fontFamily: Constants.OPEN_SANS,
              fontWeight: FontWeight.w500,
        ...
        ElevatedButton(
          onPressed: (){
            NavigationService.pushScreen(context,
                screen:  const SignupPage(theUsertype: UserType.businness),
                withNavBar: false
            );
          },
          child: const Text("Get Started"),
         ...
         Row(
          ...
          children: [
            ...
            TextButton(
                onPressed: (){
                  NavigationService.pushScreen(context,
                      screen:  const LoginPage(theUsertype: UserType.businness,),
                      withNavBar: false
                  );
                },
                child:  Text(
