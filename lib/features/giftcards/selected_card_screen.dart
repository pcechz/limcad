        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                            color: grey.withOpacity(0.2), shape: BoxShape.rectangle, borderRadius: const BorderRadius.all(Radius.circular(5))),
                        child: Center(
                          child: Text('Change card',
                              textAlign: TextAlign.center,
                              style: secondaryTextStyle(color: CustomColors.blackPrimary, size: 12,)),
                        )
                    ),
                  ]
              ).paddingBottom(10),
              Card(
                child: placeHolderWidget(height: 120, width: MediaQuery.of(context).size.width), // replace with your image
              ),
              ...
              CustomTextArea(
                label: 'Leave a message for recipient (Optional)',
                labelText: "Enter Sender Email",
                maxLines: 5,
              ).paddingBottom(24),
