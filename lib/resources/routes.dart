...
final Map<String, WidgetBuilder> routes = {
  ...
  SignupPage.routeName: (context) => const SignupPage(theUsertype: UserType.personal),
  SignupOtpPage.routeName: (context) => const SignupOtpPage(from: "",),
  CreatePassword.routeName: (context) => const CreatePassword(),
  LoginPage.routeName: (context) => const LoginPage(),
  LandingPage.routeName: (context) =>  LandingPage(),
  UserTypePage.routeName: (context) =>  UserTypePage(),
  GetStartedPage.routeName: (context) =>  const GetStartedPage(theUsertype: UserType.personal,)
...
class NavigationService {
  ...
  static pushScreen(BuildContext context, {required Widget screen, bool withNavBar = true}) =>
